...
export function Content() {
  ...
  const baseURL = 'https://back-end-81o6.onrender.com/santos'
  ...
  return (
    <>
      <Header
        title='Santos da Igreja Católica'
        subtitle='Conheçam as grandes pessoas que Deus deixou para nos inspirar'
        image={listaImg}
      />
      ...
      <div >
        <h2 className={styles.projectsTitle}>Cadastre um novo Santo:</h2>
